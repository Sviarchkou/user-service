...
public class PaymentCardFlowTests {
    ...
    void getPaymentCardByIdWhenExists(){
        ...
        paymentCardDto.setExpirationDate("10/30");
    ...
    void getAllUserCards(){
        ...
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertNotNull(response.getBody());
        response.getBody().forEach(u -> u.setCreatedAt(u.getCreatedAt().truncatedTo(ChronoUnit.SECONDS)));
        listDto.forEach(u -> u.setCreatedAt(u.getCreatedAt().truncatedTo(ChronoUnit.SECONDS)));
    ...
    void updatePaymentCard(){
        ...
        user.setSurname("Ronaldo");
        user.setEmail("cristiano@gmail.com");

        user = userRepository.save(user);

        PaymentCardDto paymentCardDto = new PaymentCardDto();
        paymentCardDto.setNumber("1111333344446666");
        paymentCardDto.setUserId(user.getId());
        paymentCardDto.setHolder("CRISTIANO RONALDO");
        paymentCardDto.setExpirationDate("09/31");

        paymentCardDto = paymentCardService.create(paymentCardDto);

        paymentCardDto.setHolder("RONALDO CRISTIANO");
        paymentCardDto.setExpirationDate("07/29");
    ...
    void updateUserById(){
        ...
        paymentCardDto.setExpirationDate("12/32");
    ...
    void changePaymentCardActivityById(){
       ...
       // userDto = userService.create(userDto);
        ...
        ResponseEntity<Void> response = restTemplate.exchange(
                "/api/v1/cards/" + paymentCardDto.getId() + "?active=true",
                HttpMethod.PATCH,
                null,
                Void.class);
    ...
    void deletePaymentCardById() throws InterruptedException {
        User user = new User();
        ...
        paymentCard.setExpirationDate("09/31");
